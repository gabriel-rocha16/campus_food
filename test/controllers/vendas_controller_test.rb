...
class VendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venda" do
    assert_difference("Venda.count") do
      post vendas_url, params: { venda: { cliente_id: @venda.cliente_id, data: @venda.data, funcionario_id: @venda.funcionario_id, total: @venda.total } }
    end
  ...
  test "should update venda" do
    patch venda_url(@venda), params: { venda: { cliente_id: @venda.cliente_id, data: @venda.data, funcionario_id: @venda.funcionario_id, total: @venda.total } }
